...
class TorchAoConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        filter_fn (`typing.Optional[typing.Callable[[torch.nn.modules.module.Module, str], bool]]`, *optional*):
            function that takes a torch.nn.Module instance and fully qualified name of the module, returns True if we want to apply quantization on the weight of the module
        kwargs (`Dict[str, Any]`, *optional*):
    ...
    ```python
    # apply to linear modules only
    def filter_fn(module: nn.Module, fqn: str) -> bool:
        return isinstance(module, nn.Linear)

    quantization_config = TorchAoConfig("int4_weight_only", filter_fn=filter_fn, group_size=32)
    ...
    def __init__(self, quant_type: str, filter_fn: Optional[Callable[[torch.nn.Module, str], bool]] = None, **kwargs):
